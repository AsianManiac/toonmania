...
const ToonDetailsItem = () => {
    return ( 
        <div className="flex flex-col">
            <div 
                style={{backgroundImage: `url('/home_bg011.jpg')`, backgroundSize: "cover"}}  
            ...
            <div className="z-20">
                <Container>
                    <div className="relative h-[50vh] lg:h-[30vh]">
                        <p>Clososoovsjbvbdsavask vajlkfbvnajb anvajva jvbaofvank jab va vlabnfv afjab</p>
                        <Image
                            alt="Cover Image"
                            objectFit="fit"
                            fill
                    ...
                    <div className="flex flex-row">
                        {/* Episode Area */}
                        <div className="bg-white dark:bg-[#212122] w-[66%] pt-7 px-5 pb-20">
                            <div className="flex flex-col">
                                {/* head area */}
                                <div className="border-y-[1px] border-[#f5f5f5] py-6 text-center">
                                    <strong>Read <em>5</em> more new episodes on the app!</strong><br />
                                    <p>Scan the QR code to download the <em>WEBTOON</em> app on the App Store or Google Play.</p>
                                </div>
                                {/* Episodes */}
                        ...
                        {/* Details Area */}
                        <div className="bg-white dark:bg-[#212122] w-[34%] pt-9 pl-8">
                            <div className="pt-3">
                                <ul className="flex flex-row space-x-2 pb-4">
                                    ...
                                    <li className="flex flex-row items-center justify-center">
                                        <button className="bg-[#00dc64] font-medium text-white rounded-xl pb-1 text-sm text-center px-3">Rate</button>
                                    </li>
                                </ul>
                                <div className="pb-3">
                                    <Button
                                ...
                                <p className="font-normal text-sm w-[80%] text-justify">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Sequi fugit nisi aperiam eaque, placeat odit odio assumenda deleniti cupiditate nemo delectus atque laudantium nihil exercitationem obcaecati reiciendis, libero soluta, earum ea minus facilis. Nihil corporis illum blanditiis nesciunt nobis beatae.</p>
                                <Button 
                                    variant={"default"} 
                                    size={"lg"}
                                    className="rounded-3xl mt-5 w-[80%]"
                                >First Episode &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="text-end"> <ChevronRight size={16} className="text-end"/> </span></Button>
                            </div>
                        </div>
                    </div>
                            ...
                            <li className="flex flex-1 items-center justify-between  cursor-pointer bg-white">
                                <div className="flex flex-row items-center space-x-4">
                                    ...
                                    <span className="text-start">
                                        ...
                                        <p className="font-semibold text-sm text-[#00dc64]">{item.likes}</p>
                                    </span>
                                </div>
                            </li>
                        ))}
